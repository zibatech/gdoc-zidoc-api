...
Ahora si empecemos con las peticiones, podremos consultar *expedientes* y *documentos*, esto proveyendo filtros los parámetros **`GET`** de la petición. A continuación dichos parámetros, tipos en base de datos, etiquetas y equivalencia en formularios de **`html`**:
